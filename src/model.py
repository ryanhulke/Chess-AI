...
class BidirectionalPredictor(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.rotary_embedding = RotaryEmbedding(config.rotary_n_emb, cache_if_possible = False)
        ...
        self.predictor_head = nn.Linear(config.n_emb, config.output_size, bias=False)
